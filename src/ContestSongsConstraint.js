export const contestSongs = [
    {
        name: 'king妃jack躍 / 宮守文学 feat. 初音ミク',
    ...
    {
        name: 'ネオンライトの海を往く / Ponchi♪ feat. 初音ミク',
    ...
    {
        name: 'ミュウテイション / Rin（Kuroneko Lounge） feat. 初音ミク',
    ...
    {
        name: 'Entrust via 39 / ikomai feat. 初音ミク',
